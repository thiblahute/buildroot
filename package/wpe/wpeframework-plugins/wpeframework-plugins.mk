...
WPEFRAMEWORK_PLUGINS_VERSION = dc8b45e5128428280bcd6eca32e6a3b9fa4dfb49
...
WPEFRAMEWORK_PLUGINS_TVCONTROL_FREQUENCY_LIST=$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_PLUGINS_TVCONTROL_FREQUENCY_LIST))
WPEFRAMEWORK_PLUGINS_TVCONTROL_TUNE_PARAM=$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_PLUGINS_TVCONTROL_TUNE_PARAM))
WPEFRAMEWORK_PLUGINS_TVCONTROL_COUNTRY_CODE=$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_PLUGINS_TVCONTROL_COUNTRY_CODE))
WPEFRAMEWORK_PLUGINS_TVCONTROL_COUNTRY_REGION_ID=$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_PLUGINS_TVCONTROL_COUNTRY_REGION_ID))

WPEFRAMEWORK_PLUGINS_POST_INSTALL_TARGET_HOOKS += WPEFRAMEWORK_PLUGINS_POST_TARGET_INITD

define WPEFRAMEWORK_PLUGINS_POST_TARGET_INITD
sed -i 's/%FREQUENCY_LIST%/${WPEFRAMEWORK_PLUGINS_TVCONTROL_FREQUENCY_LIST}/g' $(TARGET_DIR)/etc/init.d/S80WPEFramework
sed -i 's/%TUNE_PARAM%/${WPEFRAMEWORK_PLUGINS_TVCONTROL_TUNE_PARAM}/g' $(TARGET_DIR)/etc/init.d/S80WPEFramework
sed -i 's/%COUNTRY_CODE%/${WPEFRAMEWORK_PLUGINS_TVCONTROL_COUNTRY_CODE}/g' $(TARGET_DIR)/etc/init.d/S80WPEFramework
sed -i 's/%COUNTRY_REGION_ID%/${WPEFRAMEWORK_PLUGINS_TVCONTROL_COUNTRY_REGION_ID}/g' $(TARGET_DIR)/etc/init.d/S80WPEFramework
endef
