...
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_SICONTROL_ATSC),y)
WPEFRAMEWORK_PLUGINS_DEPENDENCIES += dvb-apps
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DWPEFRAMEWORK_SICONTROL_PARSER_ATSC=ON
else
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DWPEFRAMEWORK_SICONTROL_PARSER_DVB=ON
endif
