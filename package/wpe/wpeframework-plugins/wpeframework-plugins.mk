...
WPEFRAMEWORK_PLUGINS_VERSION = e56ce8222b3e61e4fe4be1efbcd9dff70a09aebc
...
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DWPEFRAMEWORK_PLUGIN_IOCONNECTOR=ON
endif
...
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DWPEFRAMEWORK_PLUGIN_FRONTPANEL=ON
endif
...
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_PLUGIN_RTSPCLIENT),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DWPEFRAMEWORK_PLUGIN_RTSPCLIENT=ON
endif
...
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DWPEFRAMEWORK_PLUGIN_POWER_AUTOSTART=true
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_POWER_GPIOPIN),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DWPEFRAMEWORK_PLUGIN_POWER_GPIOPIN=$(BR2_PACKAGE_WPEFRAMEWORK_POWER_GPIOPIN)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_POWER_GPIOTYPE),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DWPEFRAMEWORK_PLUGIN_POWER_GPIOTYPE=$(BR2_PACKAGE_WPEFRAMEWORK_POWER_GPIOTYPE)
endif
endif

ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_STREAMER),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DWPEFRAMEWORK_PLUGIN_STREAMER=ON
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DSTREAMER_IMPLEMENTATION=QAM
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DWPEFRAMEWORK_PLUGIN_STREAMER_FRONTENDS=$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_STREAMER_FRONTENDS))
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DWPEFRAMEWORK_PLUGIN_STREAMER_DECODERS=$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_STREAMER_DECODERS))
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_STREAMER_DVB),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DWPEFRAMEWORK_PLUGIN_STREAMER_STANDARD=DVB
else
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DWPEFRAMEWORK_PLUGIN_STREAMER_STANDARD=ATSC
endif
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_STREAMER_SI_PARSING),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DWPEFRAMEWORK_PLUGIN_STREAMER_SI_PARSING=ON
endif
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_STREAMER_TS_SCANNING),y)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DWPEFRAMEWORK_PLUGIN_STREAMER_TS_SCANNING=ON
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DWPEFRAMEWORK_PLUGIN_STREAMER_HOME_TS=$(BR2_PACKAGE_WPEFRAMEWORK_STREAMER_HOME_TS)
endif
endif
